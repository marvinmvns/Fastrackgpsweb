...
<script type="text/javascript" src="javascript/checarAlertas.js"></script>
<script type="text/javascript" src="javascript/cancelarComando.js"></script>
<script type="text/javascript" src="javascript/alterarVeiculo2.js"></script>
<script type="text/javascript" src="javascript/enviarComando.js"></script>
<script type="text/javascript" src="javascript/verificarStatusSinalGPS.js"></script>
				...
				<table width="266px" style="margin-left: -20px;">
					<tr>
						...
						<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.consultarHistorico.txtDataInicio);return false;" hidefocus="">
							<img name="popcal" src="javascript/calendario/calbtn.jpg" alt="Selecione uma data" title="Selecione uma data" align="absmiddle" border="0" >
						</a>
							...
							<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.consultarHistorico.txtDataFinal);return false;" hidefocus="">
								<img name="popcal" src="javascript/calendario/calbtn.jpg" alt="Selecione uma data" title="Selecione uma data" align="absmiddle" border="0" style="margin-left:1px">
							</a>							
...
<iframe name="gToday:normal:agenda.js" id="gToday:normal:agenda.js" src="javascript/calendario/ipopeng.htm" style="visibility: visible; z-index: 999; position: absolute; left: -500px; top: 31px; width: 174px; height: 172px;" frameborder="0" height="189" scrolling="no" width="174"></iframe>
