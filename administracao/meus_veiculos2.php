			...
			<div id="div_cadastro" class="conteudo" style="display:block;">
				<div>
					Adicione um novo bem <br />
						...
						<!--span style="font-size:11px">Não lembra os comandos? Use o <a href="configuracao/" target="_top" style="color:#0099FF">Configurador</a></span> <img src="../imagens/novidade.png" /> <br /!-->
