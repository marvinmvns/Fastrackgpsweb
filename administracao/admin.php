						...
						for ($i=0; $i < mysql_num_rows($resUsu); $i++) {
							...
							echo "<tr id='linhaContaCliente". $rowUsu[id] ."'>";
								...
								echo "<td><select id='listaAtivoCliente". $rowUsu[id] ."' name='listaAtivoCliente". $rowUsu[id] ."' class='campoNovoVeiculo'>";
									...
									echo "</select>";
								echo "</td>";
								echo "<td valign='top'> <div style='width:46px'> <a href='/default.php?user=". $rowUsu[id] ."&admin=true' target='_top'> <img border=0 src='../imagens/admin.png' style='height:25px' title='Acessar conta do cliente' alt='Acessar conta do cliente'/> </a></div></td>";
								echo "<td valign='top' style='color:black;font-weight:bold'> <div style='width:46px'> <a href='javascript:void(0);'> <img border=0 src='../imagens/frota.gif' style='height:25px' title='Frota do cliente' alt='Frota do cliente' onclick='abrirFrotaCliente(". $rowUsu[id] .");' /> </a> <sup>". $rowUsu[qtFrota] ."</sup></div></td>";
