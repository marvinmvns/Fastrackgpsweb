...
var intervaloIdGrid = 10000;
var intervaloIdKml = 10000;
...
function alterarComboVeiculo(obj) {
	if (obj.value != '' && obj.value != 'ALL') {
		...
		document.getElementById('spanComandos').innerHTML='Envia comandos ao gps &nbsp &nbsp &nbsp &nbsp Senha';		
		...
		if (obj.value == 'ALL') {
			...
			if (parent.bottom.location.href.indexOf("listagem.html") != -1) {
				...
				try {setTimeout("carregandoRotas()" , 12000);} catch (e) {}
				//carregandoRotas();
				//parent.bottom.document.getElementById('nrImeiLista').value = obj.value;
