...
$resUsu = "select * from bem, pagtos1 where codc = '".$id."' and bem.cliente = '".$cliente."' and bem.activated = 'S' and pago = 'N' ";				
...
echo "</tr>";
echo "<input type='hidden' name='ref_transacao' value='". $row['codc'] ."' />";
...
echo '<br>';
echo '<br>';
echo 'Atenção !!!  Para pagamento anual há uma grande desconto ! Somente R$'; 
echo (80 * $numero) ;
echo '<br>';
echo 'Para isso devera entrar em contato pelo e-mail marcus@segundo.me ou pelo Whatsapp (11) 9-8741-5290';
echo '<br>';
