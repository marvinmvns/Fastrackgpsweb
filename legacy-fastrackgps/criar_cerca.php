...
<head>
	...
	<script type="text/javascript" src="../shared-modules/assets/js/jquery-1.4.2.min.js"></script>
	<script type="text/javascript" src="../shared-modules/assets/js/polygon.min.js"></script>
