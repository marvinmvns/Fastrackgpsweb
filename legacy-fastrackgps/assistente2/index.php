...
<script type="text/javascript" src="js/jquery.smartWizarda.js"></script>
...
<div class="demoHead">   
  <h2>Formulario de Configuração</h2>
</div>
...
<!-- Tabs -->
  		<div id="wizard" class="swMain">
  			...
  			<div id="step-1">	
            <h2 class="StepTitle">Passo 1: Forneça os dados do seu Rastreador</h2>
            <table cellspacing="3" cellpadding="3" align="center">
          			<tr>
                    	...
                    	<td align="left">
                        <select id="modelo" name="modelo" class="txtBox">
                          <option value="">-Selecione seu rastreador-</option>
					...
					<option value="TK101">TK101</option>
					...
					<option value="86 VT">86 VT</option>
                    	...
                    	<td align="left"><span id="msg_modelo"></span>&nbsp;</td>
          			</tr>    

					
          			<tr>
                    	<td align="right">Telefone do Rastreador :</td>
                    	<td align="left">
                    	  <input type="text" id="telefone" name="telefone" value="" class="txtBox">
                      </td>
                    	<td align="left"><span id="msg_telefone"></span>&nbsp;</td>
          			</tr>

					<tr>
                    	<td align="right">Operadora:</td>
                    	<td align="left">
                        <select id="operadora" name="operadora" class="txtBox">
                    	...
                    	<td align="left"><span id="msg_operadora"></span>&nbsp;</td>
          			</tr>    
					
					
					<tr>
                    	<td align="right">Senha Aparelho :</td>
                    	<td align="left">
                    	  <input type="text" id="senha" name="senha" value="" class="txtBox">
                      </td>
                    	<td align="left"><span id="msg_senha"></span>&nbsp;</td>
          			</tr>
