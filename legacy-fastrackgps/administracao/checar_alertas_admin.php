...
while($data = mysql_fetch_assoc($result))
{
	echo "<tr>";
		...
		echo "<td><a href='/default.php?user=". $data[cliente] ."&admin=true' target='_top' style='color:#0099FF'> <img border=0 src='../shared-modules/assets/images/admin.png' style='height:25px' title='Acessar conta do cliente' alt='Acessar conta do cliente'/> ". $data[nomeUsuario] ."</a></td>";
	echo "</tr>";
