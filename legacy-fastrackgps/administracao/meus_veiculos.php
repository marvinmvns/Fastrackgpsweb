...
function adicionarNovaLinhaVeiculos() {
	...
	if (document.getElementById("alertNenhumVeiculo") != null) {
		...
		if (totalVeiculos == 0) {
			...
			novaCelulaTopo.innerHTML = "<td><img src='../shared-modules/assets/images/salvar_todos.gif' title='Salvar todos' alt='Salvar todos' onclick='salvarTodos();' /></td>";
	...
	novaCelula.innerHTML = "<div style='width:40px'><img id='imgGravar"+ totalVeiculos +"' src='../shared-modules/assets/images/salvar.png' title='Salvar veiculo' alt='Salvar veiculo' onclick='adicionarVeiculoAdmin("+ totalVeiculos +");' /><img id='imgExecutando"+ totalVeiculos +"' style='display:none' src='../shared-modules/assets/images/executando.gif' title='Executando...' alt='Executando...' /><img id='imgSucesso"+ totalVeiculos +"' style='display:none' src='../shared-modules/assets/images/sucesso.png' title='Alteração salva' alt='Alteração salva' /></div>";
	
	novaCelula = novaLinha.insertCell(10);
	novaCelula.innerHTML = "<div style='width:40px'><a href='javascript:void(0);'><img border=0 id='imgExcluirBem"+ totalVeiculos +"' src='../shared-modules/assets/images/lixeira.png' title='Excluir item' alt='Excluir item' onclick='excluirBemUsuario("+ totalVeiculos +");' /></a> <img border=0 id='imgExcluindo" + totalVeiculos + "' style='display:none' src='../shared-modules/assets/images/executando.gif' title='Executando...' alt='Executando...' /> </div>";	
