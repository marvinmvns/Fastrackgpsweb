...
<script type="text/javascript" src="javascript/comandarHistorico.js"></script>
<script language="JavaScript">
	...
	function imprimirHistorico() { 
	  ...
	  var docprint=window.open("","",disp_setting); 
	   ...
	   docprint.document.write('<link rel="stylesheet" type="text/css" href="css/historico.css" />');
